class ZodiacsController < ApplicationController
  def sign
    @the_input = params["the_sign"].capitalize
    @zodiac = Zodiac.find_by({:sign => params["the_sign"]}).fortune
  end

  def creature
    @the_inputs = Zodiac.find_by({:creature => params["the_creature"]})
    @zodiac = Zodiac.find_by({:creature => params["the_creature"]}).fortune
  end
