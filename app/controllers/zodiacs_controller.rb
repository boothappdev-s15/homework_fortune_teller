class ZodiacsController < ApplicationController
  ...
  def sign
    @input = params["the_sign"].downcase.capitalize
    @prediction = Zodiac.find_by({ :sign => params["the_sign"].downcase}).fortune
  ...
  def creature
    @input = Zodiac.find_by({ :creature => params["the_creature"].downcase}).sign.capitalize
    @prediction = Zodiac.find_by({ :creature => params["the_creature"].downcase}).fortune
