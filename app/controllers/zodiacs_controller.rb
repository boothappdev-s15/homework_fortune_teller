class ZodiacsController < ApplicationController
 ...
 def sign
  #@type = params["the_sign"].present? ? params["the_sign"] : "I don't know"
  #@type = params["the_sign"].capitalize
  @type = Zodiac.find_by({ :sign => params["the_sign"] } ).present? ? Zodiac.find_by({ :sign => params["the_sign"] } ).sign : "I don't know"
  @creature = Zodiac.find_by({ :sign => params["the_sign"] } ).present? ? Zodiac.find_by({ :sign => params["the_sign"] } ).creature : "I don't know"
  @prediction = Zodiac.find_by({ :sign => params["the_sign"] } ).present? ? Zodiac.find_by({ :sign => params["the_sign"] } ).fortune : "Sorry that isn't a Zodiac"
  #render 'default'
 end

 def creature
  @type = Zodiac.find_by({ :creature => params["the_creature"] } ).present? ? Zodiac.find_by({ :creature => params["the_creature"] } ).sign : "I don't know"
  @creature = Zodiac.find_by({ :creature => params["the_creature"] } ).present? ? Zodiac.find_by({ :creature => params["the_creature"] } ).creature : "I don't know"
  #@type = params["the_creature"].capitalize
  @prediction = Zodiac.find_by({ :creature => params["the_creature"] } ).present? ? Zodiac.find_by({ :creature => params["the_creature"] } ).fortune : "Sorry that isn't a Zodiac"
  #render 'default'
 end
